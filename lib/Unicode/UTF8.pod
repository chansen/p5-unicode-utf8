...
=item Can't map surrogate code point U+%.4X to UTF-8 encoding form
...
=item Can't map restricted code point U-%.8X to UTF-8 encoding form
...
=item Can't map super code point \x{%X} to UTF-8 encoding form
